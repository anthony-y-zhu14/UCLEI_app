...
function cancelOrder(orderId, user){
    ...
    let sellOrderArr = JSON.parse(fs.readFileSync(databasePath+"/database/orders/openSellOrders.json"));
    let buyOrderArr = JSON.parse(fs.readFileSync(databasePath+"/database/orders/openBuyOrders.json"));
...
function updateBuyOrdersData(d){
    fs.writeFileSync(databasePath+"/database/orders/openBuyOrders.json", JSON.stringify(d, null, 2));
}
/*
    Write to sell order database
*/
function updateSellOrdersData(d){
    fs.writeFileSync(databasePath+"/database/orders/openSellOrders.json", JSON.stringify(d, null, 2));
}
/*
    Write to user database
*/
function updateUserDataBase(usersDatabase){
    fs.writeFileSync(databasePath+"/database/users/users.json", JSON.stringify(usersDatabase, null, 2));
}
/*
...
function updateStockDatabase(stockDatabase){
    ...
    fs.writeFileSync(databasePath+"/database/stocks/data.json", JSON.stringify(stockDatabase, null, 2))
}
