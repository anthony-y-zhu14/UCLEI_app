...
app.get('/getWatchlist', (req, res) => {
    if (isSessionValid(req.session, req.session.user)){
        const stockDatabase = JSON.parse(fs.readFileSync(databasePath + "/database/stocks/data.json"));
...
app.get('/getEvents', (req, res) => {
    if (isSessionValid(req.session, req.session.user)){
        const userDatabase = JSON.parse(fs.readFileSync(databasePath +"/database/users/users.json"));
